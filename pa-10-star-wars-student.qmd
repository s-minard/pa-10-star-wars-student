...
> Both extract the titles of the fourth element, but one uses the double brackets and the other uses the pluck function.
...
> As the total number of vehicles increases, the number of hyperdrive vehicles increases for Prequels and Originals. 
...
sw_peeps2 <- sw_peeps %>% 
  ...
  right_join(film_names, by = c("films" = "url")) %>% 
...
> The heaviest character besides Jabba is Grievous.
